...
module Com_canonical_dbusmenu : sig
  ...
  val m_EventGroup : ((int32 * string * OBus_value.V.single * int32) list, int32 list) Method.t
  val m_GetGroupProperties : (int32 list * string list, (int32 * (string * OBus_value.V.single) list) list) Method.t
  val m_GetLayout : (int32 * int32 * string list, int32 * (int32 * (string * OBus_value.V.single) list * OBus_value.V.single list)) Method.t
  val m_GetProperty : (int32 * string, OBus_value.V.single) Method.t
  val s_ItemActivationRequested : (int32 * int32) Signal.t
  val s_ItemsPropertiesUpdated : ((int32 * (string * OBus_value.V.single) list) list * (int32 * string list) list) Signal.t
